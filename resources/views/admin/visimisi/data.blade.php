        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active"><a href="{{ url('add/visimisi') }}" class="btn btn-primary">
                        ...
                        <table id="example2" class="table table-bordered table-hover text-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $a->tipe }}</td>
                                    <td>
                                        <a href="{{ url('edit/visimisi/'.$a->id) }}" class="btn btn-success">
                                            <i class="nav-icon fas fa-edit"></i>Edit</a>
                                        <a href="{{ url('delete/visimisi/'.$a->id) }}" class="btn btn-danger">
