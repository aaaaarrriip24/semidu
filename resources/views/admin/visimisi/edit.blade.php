        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form enctype="multipart/form-data" autocomplete="off" action="{{ url('update/visimisi') }}"
                            method="post">
                            @csrf
                            <input hidden type="text" name="id" value="{{ $k->id }}">
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Deskripsi</label>
                                <input type="text" class="form-control" id="#" name="deskripsi" value="{{ $k->deskripsi }}" required>
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Tipe</label>
                                <select name="tipe" id="">
                                    <option value="{{ $k->tipe }}" selected deleted>Pilih Tipe</option>
                                    <option value="1">Visi</option>
                                    <option value="2">Misi</option>
                                </select>
                            </div>
