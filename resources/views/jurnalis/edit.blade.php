            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form enctype="multipart/form-data" autocomplete="off" action="{{ url('update/artikel') }}" method="post">
                                @csrf
                                ...
                                <div class="mb-3">
                                    ...
                                    <input value="{{ $k->deskripsi }}" type="text" class="form-control" id="#" name="deskripsi"
                                        required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                        <input type="date" class="datepicker form-control datetimepicker-input"
                                            data-target="#reservationdate" name="tanggal" value="{{ date('d-m-Y', strtotime($k->tanggal)) }}"/>
